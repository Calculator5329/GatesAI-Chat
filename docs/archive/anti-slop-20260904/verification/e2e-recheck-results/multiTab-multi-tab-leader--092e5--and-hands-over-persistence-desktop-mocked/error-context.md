...
- Name: multiTab.spec.ts >> multi-tab leader election >> closing the leader refreshes the follower and hands over persistence
- Location: tests/e2e/multiTab.spec.ts:56:3
