...
- [ ] A25 Handles starting-route consumer (2026-09-05): documentation handoff complete; pending a zero-exit full Gates check and supported integration. Earlier checkpoint: CI 1361 and E2E 146 passed; later full run: 145 passed / 1 lightbox failure, then one unchanged focused pass. Installed plugin /run smoke and 105-journey byte parity passed. Preserve both test receipts in docs/design-handles-route-consumer-20260905.md; the focused pass does not make the full run green.
