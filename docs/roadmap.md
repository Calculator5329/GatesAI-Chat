...
- [x] Bridge protocol spec in docs/ *(done 2026-07-16 — canonical app-side
      contract is `docs/bridge-protocol.md`; retained here as a resolved alias
      of the Architecture item above, not a second implementation task)*
