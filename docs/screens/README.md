...
| `desktop-mocked/04-chat-memory-disclosure.png` | `/#/thread/tool` with the memory chip open | Assistant turn showing the memory disclosure and its source excerpts. |
| `desktop-mocked/05-command-palette.png` | Active chat + command palette | Command palette over seeded threads and actions. |
| `desktop-mocked/06-model-popover.png` | Active chat + model picker | Composer model popover with source and capability controls. |
| `desktop-mocked/07-menu-agent.png` | `/#/menu/agent` | Agent settings with instructions, memory, and semantic memory. |
| `desktop-mocked/08-menu-models.png` | `/#/menu/models` | OpenRouter key, local models, search, and image model controls. |
| `desktop-mocked/09-menu-settings.png` | `/#/menu/settings` | Settings with conversations, theme, export/import, and danger zone. |
| `desktop-mocked/10-sidebar-agent-task-group.png` | `/#/thread/active` with agent task | Sidebar showing a seeded Agent tasks group. |
| `desktop-mocked/11-mobile-first-run.png` | Mobile `/` without provider | Mobile first-run onboarding. |
| `desktop-mocked/12-mobile-active-chat.png` | Mobile `/#/thread/active` | Mobile active chat surface. |
