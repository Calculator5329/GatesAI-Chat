// Shared workspace-image loader (LRU data-url cache + bridge round-trip) for chat and Gallery.
// Store-aware shared UI helper: lives in components/media/ so neither feature imports the other.
// Invariant: caches view state only; persistent state stays in stores.
