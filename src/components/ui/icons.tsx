...
export const Icons = {
  ...
  Gear:      () => <Ico d={<><circle cx="8" cy="8" r="2" /><path d="M8 1.6l1.1 1.5 1.8-.5.6 1.8 1.8.6-.5 1.8L14.4 8l-1.6 1.2.5 1.8-1.8.6-.6 1.8-1.8-.5L8 14.4l-1.1-1.5-1.8.5-.6-1.8-1.8-.6.5-1.8L1.6 8l1.6-1.2-.5-1.8 1.8-.6.6-1.8 1.8.5z" /></>} />,
};
