...
export const MODELS: Model[] = [
  ...
  { id: 'or-claude-sonnet-4.7',    name: 'Claude Sonnet 4.7',    vendor: 'Anthropic', providerId: 'openrouter', providerModelId: 'anthropic/claude-sonnet-4.7', description: 'Anthropic daily-driver coding and agent model.', contextLength: 1_000_000, pricing: { prompt: 3, completion: 15 } },
  ...
  { id: 'or-claude-haiku-4.6',     name: 'Claude Haiku 4.6',     vendor: 'Anthropic', providerId: 'openrouter', providerModelId: 'anthropic/claude-haiku-4.6', description: 'Fast Claude model for lightweight agent work.', contextLength: 200_000, pricing: { prompt: 1, completion: 5 } },
