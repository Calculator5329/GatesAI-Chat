...
export const MODELS: Model[] = [
  ...
  { id: 'or-claude-sonnet-4.7',    name: 'Claude Sonnet latest', vendor: 'Anthropic', providerId: 'openrouter', providerModelId: '~anthropic/claude-sonnet-latest', description: 'OpenRouter latest alias for the Claude Sonnet family. Retains the old stable id for saved threads.', contextLength: 1_000_000, pricing: { prompt: 3, completion: 15 } },
  { id: 'or-claude-sonnet-4.6',    name: 'Claude Sonnet 4.6',    vendor: 'Anthropic', providerId: 'openrouter', providerModelId: 'anthropic/claude-sonnet-4.6', description: 'Prior Claude Sonnet coding and agent model.', contextLength: 200_000, pricing: { prompt: 3, completion: 15 } },
  ...
  { id: 'or-claude-haiku-4.5',     name: 'Claude Haiku 4.5',     vendor: 'Anthropic', providerId: 'openrouter', providerModelId: 'anthropic/claude-haiku-4.5', description: 'Prior fast Claude model for lightweight work.', contextLength: 200_000, pricing: { prompt: 1, completion: 5 } },
  ...
  { id: 'or-nemotron-3.5-content-safety', name: 'Nemotron 3.5 Content Safety free', vendor: 'NVIDIA', providerId: 'openrouter', providerModelId: 'nvidia/nemotron-3.5-content-safety:free', description: 'NVIDIA guardrail model for prompt and response moderation.', contextLength: 128_000, supportsTools: false },
