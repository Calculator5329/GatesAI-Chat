// Renders the browsable chat-history library (index.html + per-conversation
// HTML/Markdown mirrors) and writes it into the workspace via the bridge.
// Extracted from workspaceChatPersistence so the persistence module owns
