...
export function artifactContractPrompt(): string {
  return [
    ...
    '- Revise an artifact in place at the same workspace path. Do not create a second file merely to fix the first.',
    '- Use the artifact tool to create and validate finished HTML deliverables.',
  ].join('\n');
}
