...
export const fsTool: Tool = {
  def: {
    ...
    description: [
      ...
      '• `write` — write/overwrite a file. `encoding: "base64"` for binary; default utf8.',
      ...
      '  Put final deliverables under /workspace/artifacts/ and validate them with stats, schema checks, ranges, or spot checks.',
    ...
    parameters: {
      ...
      properties: {
        ...
        encoding: { type: 'string', enum: ['utf8', 'base64'], description: 'Content encoding for write/append. Default utf8.' },
