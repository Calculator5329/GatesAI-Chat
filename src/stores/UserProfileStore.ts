// Owns observable UserProfileStore state and actions for the app runtime.
...
const BRIDGE_HARNESS_PROMPT = [
  ...
  '- The default workspace includes /workspace/README.md and /workspace/notes/GatesAI-AI-Operating-Context.md. When you need details about GatesAI Chat, available tools, what the user sees, or environment limits, read the operating context file instead of guessing.',
  ...
  '- File-generation workflow is sequential: inspect or mkdir, write the script/file, run it, inspect/stat outputs, then summarize.',
